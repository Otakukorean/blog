  ...
  return (
    <nav suppressHydrationWarning className={`flex   flex-row items-center justify-between w-full  fixed bg-background top-0 z-[99999] border-b-[3px] border-b-borderBottom  py-[0.5rem] px-[7%]`}>
        ...
        <div className='flex items-center justify-center gap-4 '>
                 ...
                 <Button onClick={() => searchModal.onOpen()} style={{direction:'rtl'}} className='hidden md:inline-flex  items-center whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50  border-input hover:bg-borderGray hover:text-white/80 px-2 py-2 relative h-8 w-full justify-start rounded-[0.5rem] bg-borderGray text-sm font-normal text-muted-foreground shadow-none pr-12 sm:w-40 '>
                    <span className={cn(font.className)}>ابحث عن مقال</span>
                </Button>
          
                <CiSearch onClick={() => searchModal.onOpen()} className='md:hidden transition-all ease text-white w-6 h-6 cursor-pointer hover:text-white/75'/>
